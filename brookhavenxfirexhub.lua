...
Tabs.Main:AddButton({
    ...
    Callback = function()
        ...
        if hrp then
            -- Tween to target position com velocidade aumentada
            local tween = TweenService:Create(
                hrp,
                TweenInfo.new(3, Enum.EasingStyle.Linear), -- Velocidade aumentada (3 segundos)
                ...
                if targetPlayer and targetPlayer.Character then
                    couchConnection = RunService.Heartbeat:Connect(function()
                        ...
                        if targetHrp then
                            ...
                            local ang = os.clock() * 20 -- Velocidade de rotação aumentada
                            hrp.AssemblyAngularVelocity = Vector3.new(ang, ang * 1.5, ang * 2)
